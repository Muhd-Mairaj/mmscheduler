...
export const saveTableImage = (tableRef, fileName = 'full_timetable.png') => {
  ...
  html2canvas(clone, {
    ...
    scale: 2, // Increase scale to improve quality (2x the resolution)
    useCORS: true, // This is useful if you're using images from other domains
  }).then((canvas) => {
    ...
    link.href = canvas.toDataURL("image/png", 1.0); // Set image quality to 100%
    link.click();
  });
};
